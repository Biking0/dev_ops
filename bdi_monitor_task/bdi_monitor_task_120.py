...
def create_chk():
	...
	upload_flag=False
	check_119chk_sh='hadoop fs -ls /user/hive/warehouse/asiainfoh.db/bdi_monitor/119chk > check_upload.txt'
	check_120chk_sh='hadoop fs -ls /user/hive/warehouse/asiainfoh.db/bdi_monitor/120chk > check_upload.txt'
	
	#upload_chkfile_sh='hadoop fs -put ./119.chk /user/hive/warehouse/asiainfoh.db/bdi_monitor/119chk'
	upload_chkfile_sh='hadoop fs -put ./120.chk /user/hive/warehouse/asiainfoh.db/bdi_monitor/120chk'
...
def get_running_num():
	...
	print 'result',int(f_119[0])+int(f_120[0])
